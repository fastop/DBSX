 ...
 *													 
 * @author DRV                       			 
 * @date Enero 2020 updated Junio 2020                        			 
 *            								  		 
 * @version 1.3+          			
 ****************************************************** */ 
 ...
 */
    public function insertME($query, $erro=null)
    {
     $REX=false;
//   echo $query;
     $query = $this->cleanString($query); //addslashes($query);//Con esto evitamos estos (').
// echo $query; 

      try {            
              $this->CONN->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $this->CONN->quote($query);
    ...
    public function insertsME($query, $erro=null)
    {
        ...
        $query = addslashes($query);//Con esto evitamos estos (').
 ...
 *    Se utiliza DESPUES de lleva a cabo una consulta.
 *
 ...
 *    Se utiliza DESPUES de lleva a cabo una insercion.
 *
 *   @return 
